...
//     const elements = [output, output1, output2];
//     elements.forEach(element => {
//         const content = element.querySelector('.output-content');
//         const itemHeight = content.firstChild.offsetHeight;
//         if (content.childNodes.length * itemHeight > element.clientHeight) {
//             content.style.transform = `translateY(-${itemHeight}px)`;
//             setTimeout(() => {
//                 content.append(content.firstChild);
...
//     });
// });
//# sourceMappingURL=digits4.dev.js.map
